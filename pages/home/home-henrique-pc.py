...
class Home:
    def __init__(self, master):
        ...
        self.menuCadastro.add_command(label="Cadastro de Cliente", command=Cadastro.Cad_cli)
        self.menuCadastro.add_command(label="Cadastro de Fornecedores", command=Cadastro.Cad_forn)
        self.menuCadastro.add_separator()
        self.menuCadastro.add_command(label="Consulta Clientes", command=Cadastro.Cons_cli)
        self.menuCadastro.add_command(label="Consulta de Fornecedores", command=Cadastro.Cons_forn)
        ...
        self.menufunc.add_command(label="Consulta Funcionarios", command=Cadastro.Cons_funcio)
        ...
        self.btnpagamento = Button(self.nb, image=self.img_pag, command=Pagamento).place(x=117, y=3, width=55,height=55)

        self.img_cad_cli = PhotoImage(file="d:\\Onedrive World\\OneDrive\\dev\\programa\\pages\\home\\img\\usuario.png")
        self.btncad_cli = Button(self.nb, image=self.img_cad_cli, command=Cadastro.Cad_cli).place(x=174, y=3, width=55, height=55)

        self.img_financeiro = PhotoImage(file="d:\\Onedrive World\\OneDrive\\dev\\programa\\pages\\home\\img\\controle.png")
        self.btnfinanceiro = Button(self.nb, image=self.img_financeiro, command=Financeiro).place(x=231, y=3, width=55,height=55)

        self.img_estoque = PhotoImage(file="d:\\Onedrive World\\OneDrive\\dev\\programa\\pages\\home\\img\\estoque.png")
        self.btnestoque = Button(self.nb, image=self.img_estoque, command=Estoque).place(x=288, y=3, width=55,height=55)
...
class Pedido:
    def __init__(self):
        ...
        self.btncliente = Button(self.winpedido, image=self.img_pesq, command=Cadastro.Cons_cli)
...
class Cadastro:
    class Cad_cli:
        def __init__(self):
            ...
            btnconsulta_cli = Button(wincadastro, image=self.img_consulta_cli, command=Cadastro.Cons_cli)
    ...
    class Cad_forn:
        def __init__(self):
            ...
            self.img_consulta = PhotoImage(
                file="d:\\Onedrive World\\OneDrive\\dev\\programa\\pages\\home\\img\\consulta.png")
            btnconsulta = Button(self.wincad_forn, image=self.img_consulta,command=Cadastro.Cons_forn)
